...
public class Part4SimTest {
    ...
    public static void main(String[] args) {
        ...
        clinic = new Clinic(Integer.parseInt("10"), Integer.parseInt("10"));
        gen = new Random(System.currentTimeMillis());

        //set probability variables
        pWalkIn = Integer.parseInt("65");
        pDocAvailable = Integer.parseInt("12");
        pEmergency = Integer.parseInt("12");
        pWalkOut = Integer.parseInt("65");
